...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('CSS\teem.css')}}">
...
<div class="container">
    <div class="content_div">
        <div class="detail reveal2">
            <div class="image_div">
                <img src="{{asset('IMAGE/meet.png')}}" loading="lazy" alt="">
            </div>
            <div class="deco">
                <div class="deco1"></div>
            </div>
            <div class="person_detail">
                <p>Name: <span>Meet Patel</span></p>
                <p>Roll No:<span> 37</span></p>
                <p>Div:<span> B</span></p>
                <p>Enrollment No:<span> 22002501210067</span></p>
            </div>
        </div>

        <div class="detail reveal4">
            <div class="image_div">
                <img src="{{asset('IMAGE/anand.png')}}" loading="lazy" alt="">
            </div>
            <div class="deco">
                <div class="deco1"></div>
            </div>
            <div class="person_detail">
                <p>Name: <span>Anand Yadav</span></p>
                <p>Roll No: <span>66</span></p>
                <p>Div: <span>B</span></p>
                <p>Enrollment No: <span>22002501210066</span></p>
            </div>          
        </div>

        <div class="detail reveal">
            <div class="image_div">
                <img src="{{asset('IMAGE/yashpal.png')}}" loading="lazy" alt="">
            </div>
            <div class="deco">
                <div class="deco1"></div>
            </div>
            <div class="person_detail">
                <p>Name: <span>Yashpal</span></p>
                <p>Roll No: <span>35</span></p>
                <p>Div: <span>B</span></p>
                <p>Enrollment No:<span>22002501210038</span> </p>
            </div>
        </div>
    </div>
</div>
...
<div class="team_photo">
    <div class="team_photo_2 reveal3">
        <img src="{{asset('IMAGE\team(2).jpg')}}" loading="lazy" alt="">
    </div>
</div>
